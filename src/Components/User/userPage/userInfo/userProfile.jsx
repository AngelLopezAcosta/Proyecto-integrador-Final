...
const UserProfile = () => {
  ...
  const [selectedAge, setSelectedAge] = useState(
    userData.birth ? userData.birth.split("T")[0] : ""
  );
  const [
    phone,
    phoneValidation,
  ...
  const submitHandler = (event) => {
    ...
    if (name.er === "" && email.er === "" && dni.er === "" && phone.er === "") {
      update(
        {
        ...
        `${process.env.REACT_APP_API_URL}/Shoesar/Users/Update`
      );
    }
  };
        ...
        <article>
          ...
          {!edit ? (
            ...
            <>
              ...
              />
              {name.er !== "" && name.er && (
                <p id="phone-number-error">{makeError(name.er)}</p>
              )}
            </>
          )}
        </article>
        ...
        <article>
          ...
          {!edit ? (
            ...
            <>
              ...
              />
              {email.er !== "" && email.er && (
                <p id="phone-number-error">{makeError(email.er)}</p>
              )}
            </>
          )}
        </article>
            ...
            {!edit ? (
              ...
              <>
                <input
                  ...
                  value={dni.value}
                  onChange={(event) => {
                    dniValidation(event.target.value);
                  }}
                />
                {dni.er !== "" && dni.er && (
                  <p id="phone-number-error">{makeError(dni.er)}</p>
                )}
              </>
            )}
          </div>
